...
crossing::crossing (vertex* v1, vertex *v2)
{
  ...
  if (abs (down () -> x () - down () -> next () -> x ()) >
      abs (down () -> y () - down () -> next () -> y ()) )
  {
