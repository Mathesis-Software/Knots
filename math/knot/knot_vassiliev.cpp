...
//float knot::prmExperimental::compute() {
//	float value = 0.0;
//
...
float knot::prmSingular::compute() {
	float value = 0.0;
...
float knot::prmExperimental2::compute() {
	float value = 0.0;
